...
const Map<String, List<String>> cityMap = {
  '서울특별시': [
...
const List<String> courseTags = ['초보자', '중급자', '숙련자', '짧은거리', '긴거리', '도심', '교외', '공원', '강변', '해변', '등산로', '자전거코스', '조용한', '포토스팟'];
const List<String> groupTags = ['초보자', '중급자', '숙련자', '아침산책', '저녁산책', '주말산책', '친목모임'];